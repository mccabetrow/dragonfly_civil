-- 0108_pipeline_snapshot_refresh.sql
-- Canonicalize plaintiffs.source_system and refresh pipeline/metrics views without dropping the column.
-- migrate:up
BEGIN;
-- Preserve the canonical plaintiffs.source_system column for intake + metrics tooling.
...
ALTER COLUMN source_system
SET NOT NULL;
-- Refresh dependent metrics + pipeline snapshot views.
