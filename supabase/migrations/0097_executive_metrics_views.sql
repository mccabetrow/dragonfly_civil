-- 0097_executive_metrics_views.sql
-- Recreate the executive dashboard metrics views consumed by the API and dashboard.
-- migrate:up
BEGIN;
-- Daily intake metrics by source system/activity date.
...
authenticated,
service_role;
-- Pipeline exposure grouped by enforcement stage and collectability tier.
...
authenticated,
service_role;
-- Weekly enforcement throughput plus active exposure snapshot.
