...
BEGIN -- Determine status bucket based on outcome + interest.
...
-- Soft-close the referenced task if present.
...
-- Follow-up task when applicable.
IF (NOT v_terminal)
